  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // TrustGuard Hero Variants
        hero: "bg-gradient-to-r from-amber-500 to-orange-500 text-zinc-900 shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] font-bold",
        heroOutline: "border-2 border-white/30 bg-white/10 text-white backdrop-blur-sm hover:bg-white/20 hover:border-white/50",
        safe: "bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-md hover:shadow-lg active:scale-[0.98]",
        danger: "bg-gradient-to-r from-red-500 to-rose-600 text-white shadow-md hover:shadow-lg active:scale-[0.98]",
      },
      size: {
